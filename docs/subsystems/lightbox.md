...
- `src/components/lightbox/__tests__/MpvMediaAdapter.test.tsx`: Video.js state updates, controls, waiting state, timeline rendering, native session lifecycle, and absence of an HTML video element.
