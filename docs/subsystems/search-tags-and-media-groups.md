...
- Individual deselection uses Ctrl/Cmd-click; an ordinary click adds an ID. Rectangle selection replaces the set unless Ctrl/Cmd was held when it began.
